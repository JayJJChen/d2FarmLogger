import { ItemCategory, ITEM_CATEGORIES, ItemLibrary } from '../../models/item-library'
...
Component({
  ...
  methods: {
    ...
    loadItemsForCategory: function(category: ItemCategory) {
        if (!category) return
    ...
    filterUserItems: function(text: string) {
    ...
    onBuiltInItemSelect: function(e: any) {
        var item = e.currentTarget.dataset.item
        this.saveDrop(item)
    },

    onUserItemSelect: function(e: any) {
        var item = e.currentTarget.dataset.item
        this.saveDrop(item)
    },
    ...
    onNoteInput: function(e: any) {
        this.setData({ note: e.detail.value })
    },

    saveDrop: function(item: ItemLibrary) {
        var session = this.properties.session
