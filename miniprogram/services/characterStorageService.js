...
var CharacterStorageService = {
    ...
    validateCharacter: function (character) {
        ...
        // 职业验证
        var validClasses = [
            character_1.CharacterClass.Sorceress,
            character_1.CharacterClass.Paladin,
            character_1.CharacterClass.Necromancer,
            character_1.CharacterClass.Amazon,
            character_1.CharacterClass.Barbarian,
            character_1.CharacterClass.Druid,
            character_1.CharacterClass.Assassin
        ];
